...
{
	public class Attack2State : IOddState
	{
		static readonly int AnimationHash = Animator.StringToHash("BaseLayer.Attack2");
		public override string StateName => "Attack2";
		public override OddState State => OddState.Attacking2;
		...
		public override void OnStart()
		{
			...
			var tar = new COddController.TargetArmRotationInfo()
			{
				...
				StartAxis = Controller.StartAxis[(int)Def.OddAttackType.Normal2], //Vector3.forward,
				EndAxis = Controller.EndAxis[(int)Def.OddAttackType.Normal2], //Vector3.right,
