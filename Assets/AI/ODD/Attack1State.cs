...
{
	public class Attack1State : IOddState
	{
		static readonly int AnimationHash = Animator.StringToHash("BaseLayer.Attack1");
		public override string StateName => "Attack1";
		public override OddState State => OddState.Attacking1;
		...
		public override void OnStart()
		{
			...
			weapon.OnAttackBegin(Def.OddAttackType.Normal1);
			...
			Controller.SetCurrentAttack(Def.OddAttackType.Normal1);

			var tar = new COddController.TargetArmRotationInfo()
			{
				Angle = 0f,
				Duration = AnimationTime,
				StartAxis = Controller.StartAxis[(int)Def.OddAttackType.Normal1], //	Vector3.forward,
				EndAxis = Controller.EndAxis[(int)Def.OddAttackType.Normal1], //Vector3.right,
