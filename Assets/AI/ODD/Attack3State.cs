...
{
	public class Attack3State : IOddState
	{
		static readonly int AnimationHash = Animator.StringToHash("BaseLayer.Attack3");
		public override string StateName => "Attack3";
		public override OddState State => OddState.Attacking3;
		...
		public override void OnStart()
		{
			...
			var tar = new COddController.TargetArmRotationInfo()
			{
				...
				StartAxis = Controller.StartAxis[(int)Def.OddAttackType.Normal3], //Vector3.forward,
				EndAxis = Controller.EndAxis[(int)Def.OddAttackType.Normal3], //Vector3.right,
