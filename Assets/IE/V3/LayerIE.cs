...
namespace Assets.IE.V3
{
	...
	public class LayerIE
	{
		...
		//public float MicroHeightOffset;
		...
		public IE.V4.LayerIE Upgrade()
		{
			return new V4.LayerIE()
			{
				Slot = Slot,
				LayerType = LayerType,
		...
		//		//MicroHeightOffset = MicroHeightOffset,
		//		MicroHeightMin = MicroHeightMin,
		//		MicroHeightMax = MicroHeightMax,
		//		BlockLengthMin = BlockLengthMin,
		//		BlockLengthMax = BlockLengthMax,
		...
		//		//AppliedEffects = new List<Def.BlockEffects>(AppliedEffects),
		//		//BlockFloatOffset = BlockFloatOffset,
