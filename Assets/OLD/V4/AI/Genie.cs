...
//namespace Assets.AI
//{
//    public class Genie : MonsterScript
//    {
...
//            if (MonsterTypeID < 1)
//            {
//                MonsterTypeID = Monsters.FamilyDict["Genie"];
//                var monster = Monsters.MonsterFamilies[MonsterTypeID];
//                AttackVFXTypeID = VFXs.FamilyDict[(int)Def.VFXTarget.MONSTER]["BlinkingBubble"];
...
//                    TravelType = ProjectileTravelType.TARGETTED,
