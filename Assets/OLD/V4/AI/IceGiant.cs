...
//namespace Assets.AI
//{
//    public class IceGiant : MonsterScript
//    {
...
//            if (MonsterTypeID < 1)
//            {
//                MonsterTypeID = Monsters.FamilyDict["IceGiant"];
//                var monster = Monsters.MonsterFamilies[MonsterTypeID];
//                AttackVFXTypeID = VFXs.FamilyDict[(int)Def.VFXTarget.MONSTER]["IceRock"];
//                DefaultProjectile = new ProjectileDef
//                {
//                    AreaDamageType = ProjectileAreaDamageType.CIRCULAR,
//                    CircularRadius = 1.0f,
//                    Damage = 62.0f,
//                    DmgType = Def.DamageType.ICE,
//                    Speed = new Vector2(6.0f, 0.0f),
//                    CastVFX = new VFXDef(Def.VFXTarget.COUNT, -1, Def.VFXType.COUNT, -1),
//                    HitMask = (int)ProjectileHitMask.ALL,
//                    OnHitVFX = new VFXDef(Def.VFXTarget.MONSTER, "IceRockShort", Def.VFXType.ONHIT, 0, Def.VFXFacing.FaceCameraFull, Def.VFXEnd.SelfDestroy),
...
//            projectile.OnHitVFX.transform.localScale = new Vector3(2.5f, 2.5f, 1f);
//        }
//    }
//}
